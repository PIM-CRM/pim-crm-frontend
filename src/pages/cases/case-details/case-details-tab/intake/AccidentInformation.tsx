...
interface AccidentInformationData {
      accidentDateTime: Dayjs | null;
      location: string;
      driver: string;
      hasPassengers: string;
      occurredOnJob: string;
      ...
      hasWitnesses: string;
      policeArrived: string;
      citationsGiven: string;
}

interface AccidentInformationProps {
      data?: AccidentInformationData;
      onUpdate?: (data: AccidentInformationData) => void;
}

const defaultValues: AccidentInformationData = {
...
const AccidentInformation: React.FC<AccidentInformationProps> = ({ data, onUpdate }) => {
      const [values, setValues] = React.useState<AccidentInformationData>(data || defaultValues);

      const handleUpdate = (newValues: AccidentInformationData) => {
            setValues(newValues);
            onUpdate?.(newValues);
      };

      const handleRadioChange = (field: keyof AccidentInformationData) => (e: RadioChangeEvent) => {
            handleUpdate({
                  ...values,
      ...
      const handleInputChange = (field: keyof AccidentInformationData) => (e: React.ChangeEvent<HTMLInputElement>) => {
            handleUpdate({
                  ...values,
                  [field]: e.target.value,
            });
      ...
      return (
            <div className="p-8 bg-white">
                  <h2 className="mb-4 text-lg font-semibold">Accident Information</h2>
                  <div className="overflow-y-auto space-y-4 h-full hide-scrollbar">
                        ...
                        <div className="pb-2 space-y-1 border-b border-gray-200">
                              <div className="flex justify-between items-center">
                                    ...
                                    <Radio.Group
                                          value={values.hasPassengers}
                                          onChange={handleRadioChange('hasPassengers')}
                                    >
                              ...
                              <div className="flex justify-between items-center">
                                    <div>
                                          ...
                                          <div className="text-xs text-gray-500">
                                                Uber, Lyft, Doordash, Amazon, etc?
                                          </div>
                                    </div>
                                    <Radio.Group
                                          value={values.occurredOnJob}
                                          onChange={handleRadioChange('occurredOnJob')}
                                    >
                                          <Radio value="yes">Yes</Radio>
                                          <Radio value="no">No</Radio>
                                    </Radio.Group>
                        ...
                        <div className="pb-2 space-y-1 border-b border-gray-200">
                              <div className="flex justify-between items-center">
                                    <div>
                                          ...
                                          <div className="text-xs text-gray-500">
                                                Please send via portal, text, or email
                                          </div>
                                    </div>
                                    <Radio.Group
                        ...
                        <div className="pb-2 space-y-1 border-b border-gray-200">
                              <div className="flex justify-between items-center">
                                    ...
                                    <Radio.Group
                                          ...
                                          onChange={handleRadioChange('hasWitnesses')}
                                    >
                                          <Radio value="yes">Yes</Radio>
                                          <Radio value="no">No</Radio>
                                    </Radio.Group>
                        ...
                        <div className="pb-2 space-y-1 border-b border-gray-200">
                              <div className="flex justify-between items-center">
                                    <div>
                                          <div className="text-sm text-gray-700">
                                                Did the police arrive to the scene?
                                          </div>
                                          <div className="text-xs text-gray-500">
                                                Please list report number in notes
                                          </div>
                                    </div>
                                    <Radio.Group
                                          value={values.policeArrived}
                                          onChange={handleRadioChange('policeArrived')}
                                    >
                                          <Radio value="yes">Yes</Radio>
                                          <Radio value="no">No</Radio>
                                    </Radio.Group>
                        ...
                        <div className="pb-2 space-y-1 border-b border-gray-200">
                              <div className="flex justify-between items-center">
                                    ...
                                    <Radio.Group
                                          value={values.citationsGiven}
                                          onChange={handleRadioChange('citationsGiven')}
                                    >
                                          <Radio value="yes">Yes</Radio>
                                          <Radio value="no">No</Radio>
                                    </Radio.Group>
